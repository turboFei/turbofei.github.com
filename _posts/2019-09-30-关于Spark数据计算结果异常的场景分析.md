...
有兴趣的话，可以查看具体的分析和解决方案描述[Spark Sql Decimal Precision Overflow Analysis](https://turbofei.github.io/spark/2019/09/09/Spark-SQL-Decimal-Precision-Overflow-Analysis)。
